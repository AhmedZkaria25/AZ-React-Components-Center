...
"[project]/node_modules/@firebase/auth/dist/auth.esm.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    da("Promise", function(a) {
        ...
        b.all = function(g) {
            ...
            return m.done ? d([]) : new b(function(p, v) {
                ...
                var A = [], Q = 0;
                do A.push(void 0), Q++, d(m.value).Qa(B(A.length - 1), v), m = h.next();
                while (!m.done)
            });
        };
        return b;
...
*/ 
    ...
    function Jc(a) {
        return new D(function(b) {
            ...
            if (c) for(var e = function(h, m, p) {
                ...
                0 == c && b(d);
            }, f = 0, g; f < a.length; f++)g = a[f], Gc(g, ua(e, f, !0), ua(e, f, !1));
            else b(d);
        });
    }
    ...
    function Xc(a) {
        if (!a.xa && (a.xa = !0, a.Da(), 0 != Vc)) {
            var b = pa(a);
            if (0 != Vc && a.pa && 0 < a.pa.length) //TURBOPACK unreachable
            ;
            delete Wc[b];
        }
    }
    ...
    function vd(a, b) {
        ...
        if (!Zc) {
            ...
            if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                ...
                for(e = 0; e < d.length; e++)b.b = d[e], f = Ad(d[e], a, !1, b), c = c && f;
            }
            return c;
        }
    ...
    function Ke() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.hasOwnProperty("reactNative") ? "ReactNative" : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.hasOwnProperty("node") ? "Node" : Je() ? "Worker" : "Browser";
    }
    function Le() {
        var a = Ke();
...
*/ 
    ...
    function lh(a) {
        try {
            this.a = a || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].auth();
        } catch (b) {
...
*/ 
    ...
    function li(a) {
        if (a.c && "undefined" != typeof ha) {
            ...
            else if (a.i && 4 == mi(a)) Ed(a.Vb, 0, a);
...
*/ 
    ...
    function Ii(a, b, c) {
        ...
        c = "Node" == Ke();
        c = l.XMLHttpRequest || c && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.node && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.node.XMLHttpRequest;
    ...
    Wj.prototype.toString = function() {
        ...
        if (this.a.isOAuthProvider) {
            var b = this.a;
            try {
                var c = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].app(this.c).auth().la();
            } catch (h) {
                c = null;
            }
            b.ob = c;
    ...
    function Xj(a) {
        try {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].app(a).auth().Ga();
        } catch (b) {
            return [];
        }
    }
    ...
    function fk(a) {
        this.a = a || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.reactNative && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.reactNative.AsyncStorage;
    ...
    function Ek() {
        ...
        this.a = Gk() || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.node.localStorage;
    ...
    function Fk() {
        var a = "Node" == Ke();
        a = Gk() || a && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.node && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.node.localStorage;
        if (!a) return !1;
        try {
    ...
    function Ik() {
        ...
        this.a = Kk() || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.node.sessionStorage;
    ...
    function Jk() {
        var a = "Node" == Ke();
        a = Kk() || a && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.node && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.node.sessionStorage;
        if (!a) return !1;
        try {
            return a.setItem("__sak", "1"), a.removeItem("__sak"), !0;
        } catch (b) {
    ...
    function Kl(a, b, c, d, e) {
        var f = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION || null;
    ...
    function Im(a, b, c) {
        ...
        var d = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION ? Oe(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION) : null;
    ...
    function Mm(a, b) {
        a.$ = b;
        Ri(a.a, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION ? Oe(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION, a.$) : null);
    }
    ...
    function Qm(a) {
        try {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].app(a.m).auth();
        } catch (b) {
    ...
    function jn(a, b, c, d, e) {
        ...
        (!Te() || Ie()) && a.s && c.isOAuthProvider && (h = ek(a.s, a.l, a.m, b, c, null, g, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION || null, null, null, a.tenantId));
    ...
    function En(a) {
        ...
        M(this, "app", a);
        if (S(this).options && S(this).options.apiKey) a = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION ? Oe(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION) : null, this.a = new Ii(S(this).options && S(this).options.apiKey, Ca(Da), a);
        else throw new t("invalid-api-key");
        this.R = [];
        this.s = [];
        this.O = [];
        this.hb = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.createSubscribe(q(this.zc, this));
        this.X = void 0;
        this.bc = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.createSubscribe(q(this.Ac, this));
        Fn(this, null);
    ...
    k.Gc = function(a) {
        this.J.push(a);
        Ri(this.a, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION ? Oe(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION, this.J) : null);
    ...
    k.Xc = function(a) {
        ...
        (!Te() || Ie()) && S(this).options.authDomain && a.isOAuthProvider && (e = ek(S(this).options.authDomain, S(this).options.apiKey, S(this).name, "signInViaPopup", a, null, d, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION || null, null, null, this.T(), this.P));
    ...
    function Rn(a) {
        if (a.ba) {
            ...
            if (a.X !== a.getUid() && a.O.length) {
                for(a.X = a.getUid(), b = 0; b < a.O.length; b++)if (a.O[b]) a.O[b](Vn(a));
            }
        }
    }
    k.cc = function(a) {
    ...
    function to(a, b, c) {
        var d = !1;
        try {
            this.b = c || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].app();
        } catch (g) {
        ...
        f = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION ? Oe(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].SDK_VERSION, f) : null;
    ...
    function Bo() {
        return {
            ...
            optional: !0,
            M: function(a) {
                return !!(a && a instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].app.App);
            }
        };
    }
    function Co(a) {
    ...
    Y(En.prototype, {
        ...
        vb: {
            ...
            j: [
                V("email"),
                X(W("opt_actionCodeSettings", !0), yo(null, !0), "opt_actionCodeSettings", !0)
            ]
        },
        wb: {
    ...
    (function() {
        if ("undefined" !== typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"] && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.registerComponent) {
            var a = {
                ActionCodeInfo: {
                    Operation: {
                        EMAIL_SIGNIN: Af,
            ...
            Z(a, "RecaptchaVerifier", to, [
                X(V(), zo(), "recaptchaContainer"),
                W("recaptchaParameters", !0),
                Bo()
            ]);
            Z(a, "ActionCodeURL", Jf, []);
            Z(a, "PhoneMultiFactorGenerator", co, []);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.registerComponent({
                name: "auth",
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].registerVersion("@firebase/auth", "0.16.6");
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$index$2e$esm$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].INTERNAL.extendNamespace({
                User: Im
            });
        } else throw Error("Cannot find the firebase namespace; be sure to include firebase-app.js before this library.");
    })();
}).apply(("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable"); //# sourceMappingURL=auth.esm.js.map
}),
]);

//# sourceMappingURL=node_modules_%40firebase_auth_dist_auth_esm_0516dbd6.js.map