...
const fetchComponents = async (componentFile, arrayModify, indexModify, propertyModify)=>{
    const url = `https://raw.githubusercontent.com/AhmedZkaria22/AZ-React-Components-Center/main/src/components/%231%20Todo%20List%202/components/${componentFile}`;
    await fetch(url).then((res)=>res.text()).then((content)=>{
        arrayModify[indexModify][`${propertyModify}`] = content;
        return content;
    });
};
const fetchStyles = async (styleFile, arrayModify, indexModify, propertyModify)=>{
    const url = `https://raw.githubusercontent.com/AhmedZkaria22/AZ-React-Components-Center/blob/main/src/components/%231%20Todo%20List%202/styles/${styleFile}`;
    await fetch(url).then((res)=>res.text()).then((content)=>{
        arrayModify[indexModify][`${propertyModify}`] = content;
        return content;
    });
...
const TemplatesCards = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponents"])('TodoHeader.js', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 0, 'code');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponents"])('TodoItem.js', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 1, 'code');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchStyles"])('Todo.module.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 0, 'style');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchStyles"])('Todo.module.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 1, 'style');
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af84618d._.js.map