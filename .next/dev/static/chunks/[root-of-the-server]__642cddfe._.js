...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/index.mjs [client] (ecmascript)");
...
(()=>{
    const e = new Error("Cannot find module './account.css'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
const Login = ()=>{
    _s();
    const history = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useHistory"])();
...
_s(Login, "xZrJCpeeCDvhX1IwV/e6PktROvk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useHistory"]
    ];
});
_c = Login;
...
_s(SignUp, "/1xTVkVXRnb/fW/HMmQxRpJWi9k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useHistory"]
    ];
});
...
const UserAuth = ()=>{
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useContext"])(AuthContext);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        id: "account",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$2_React_Firebase$2f$Firebase$2f$useFireStore$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/2_React_Firebase/Firebase/useFireStore.js [client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module './input.css'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react/index.js [client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module './item.css'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$2_React_Firebase$2f$Firebase$2f$useFireStore$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/2_React_Firebase/Firebase/useFireStore.js [client] (ecmascript)");
...
(()=>{
    const e = new Error("Cannot find module './itemList.css'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$2_React_Firebase$2f$Firebase$2f$useFireStore$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/2_React_Firebase/Firebase/useFireStore.js [client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module './photoGrid.css'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
} // export const fetch = async (projectName, styleFile, arrayModify, indexModify, propertyModify) => {
 //     const url = `https://raw.githubusercontent.com/AhmedZkaria25/AZ-React-Components-Center/refs/heads/main/src/components/${projectName}/styles/${styleFile}`;
 //     await fetch(url).then(res => res.text()).then(content => {
 //         arrayModify[indexModify][`${propertyModify}`] = content;
 //         return content;
...
const TemplatesCards = ()=>{
    ...
    [
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponentsStyles"])('2_React_Firebase', 'Auth', 'account.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], fileObjectIndex, 'style');
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponentsStyles"])('2_React_Firebase', 'Header', 'header.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 5, 'style');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponentsStyles"])('2_React_Firebase', 'Input', 'input.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 6, 'style');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponentsStyles"])('2_React_Firebase', 'Item', 'item.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 7, 'style');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponentsStyles"])('2_React_Firebase', 'Item%20List', 'itemList.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 8, 'style');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponentsStyles"])('2_React_Firebase', 'Navbar', 'navbar.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 9, 'style');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2f$helpers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fetchComponentsStyles"])('2_React_Firebase', 'Photo%20Grid', 'photoGrid.css', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$TemplatesCardsData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["TemplatesCardsData"], 10, 'style');
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__642cddfe._.js.map